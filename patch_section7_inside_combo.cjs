...
const targetStart = '<div className="text-white text-left relative overflow-hidden">';
const targetEnd = '      {/* SECTION 8: FAQ */}';

let startIndex = content.indexOf(targetStart);
let endIndex = content.indexOf(targetEnd);

if (startIndex !== -1 && endIndex !== -1) {
  const replacement = `<div className="text-white text-center relative overflow-hidden">
...
`;
  ...
  let endBlock = content.substring(endIndex);
  ...
  console.log("Updated layout inner combo successfully");
} else {
