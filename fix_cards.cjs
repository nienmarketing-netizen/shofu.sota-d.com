...
const t1_old = `<div className="col-span-1 lg:col-span-2 relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col justify-between group">
...
const t1_new = `<div className="col-span-1 lg:col-span-2 relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col justify-between group">
...
const t2_old = `<div className="col-span-1 relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col group">
...
const t2_new = `<div className="col-span-1 relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col group justify-between">
              <div className="absolute inset-0 rounded-3xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-md pointer-events-none group-hover:border-[#00ADEF]/50 group-hover:shadow-[0_0_30px_rgba(0,173,239,0.15)] transition-all duration-300 [mask-image:linear-gradient(to_bottom,black_0px,black_185px,transparent_240px)] [-webkit-mask-image:linear-gradient(to_bottom,black_0px,black_185px,transparent_240px)] sm:[mask-image:none] sm:[-webkit-mask-image:none]" />
...
const t3_old = `<div className="relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col flex-1 group">
                <div className="absolute inset-0 rounded-3xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-md pointer-events-none group-hover:border-[#00ADEF]/50 group-hover:shadow-[0_0_30px_rgba(0,173,239,0.15)] transition-all duration-300 [mask-image:linear-gradient(to_bottom,black_0px,black_45%,transparent_90%)] [-webkit-mask-image:linear-gradient(to_bottom,black_0px,black_45%,transparent_90%)] sm:[mask-image:none] sm:[-webkit-mask-image:none]" />
...
const t3_new = `<div className="relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col flex-1 group justify-between">
                <div className="absolute inset-0 rounded-3xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-md pointer-events-none group-hover:border-[#00ADEF]/50 group-hover:shadow-[0_0_30px_rgba(0,173,239,0.15)] transition-all duration-300 [mask-image:linear-gradient(to_bottom,black_0px,black_185px,transparent_240px)] [-webkit-mask-image:linear-gradient(to_bottom,black_0px,black_185px,transparent_240px)] sm:[mask-image:none] sm:[-webkit-mask-image:none]" />
...
const t4_old = `<div className="relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col flex-1 group">
                <div className="absolute inset-0 rounded-3xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-md pointer-events-none group-hover:border-[#00ADEF]/50 group-hover:shadow-[0_0_30px_rgba(0,173,239,0.15)] transition-all duration-300 [mask-image:linear-gradient(to_bottom,black_0px,black_45%,transparent_90%)] [-webkit-mask-image:linear-gradient(to_bottom,black_0px,black_45%,transparent_90%)] sm:[mask-image:none] sm:[-webkit-mask-image:none]" />
...
const t4_new = `<div className="relative rounded-3xl p-6 sm:p-8 pb-0 sm:pb-8 transition-all flex flex-col flex-1 group justify-between">
                <div className="absolute inset-0 rounded-3xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-md pointer-events-none group-hover:border-[#00ADEF]/50 group-hover:shadow-[0_0_30px_rgba(0,173,239,0.15)] transition-all duration-300 [mask-image:linear-gradient(to_bottom,black_0px,black_185px,transparent_240px)] [-webkit-mask-image:linear-gradient(to_bottom,black_0px,black_185px,transparent_240px)] sm:[mask-image:none] sm:[-webkit-mask-image:none]" />
...
console.log("Section 5 cards fixed to match Section 2 EXACTLY.");
