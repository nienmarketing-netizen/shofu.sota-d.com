...
const caseStudies = [
  {
    ...
    images: [
      ...
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-1.4.webp", note: "<strong className=\"text-slate-900\">Xử lý bề mặt và Dán:</strong> Sau khi làm sạch và xói mòn bề mặt men răng ở vùng kẽ, bác sĩ bôi hệ thống keo dán <span className=\"text-[#00ADEF] font-bold\">Shofu BeautiBond Universal</span>. Lớp keo này giúp tạo ra độ bám dính vi cơ học vượt trội, đảm bảo khối composite liên kết chặt chẽ và lâu bền với mô răng thật." },
  ...
  },
  {
    ...
    images: [
      ...
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-4.7.webp", note: "<strong className=\"text-slate-900\">Đặt khuôn và Đắp lớp:</strong> Một dải màng khuôn trong suốt (celluloid matrix) được đặt vào vị trí để định hình thành bên của răng. Sau khi xử lý bằng hệ thống keo dán <span className=\"text-[#00ADEF] font-bold\">Shofu BeautiBond Universal</span>, bác sĩ đắp vật liệu composite <span className=\"text-[#00ADEF] font-bold\">Shofu Beautifil II</span> tựa theo màng khuôn để tạo hình khối hoàn hảo lấp đầy khe thưa." },
  ...
  },
  {
    ...
    images: [
      ...
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-6.2.webp", note: "<strong className=\"text-slate-900\">Kết quả sau cùng:</strong> Hình ảnh sau khi bề mặt răng được xử lý vi mài mòn và che phủ khiếm khuyết bằng một lớp siêu mỏng composite <span className=\"text-[#00ADEF] font-bold\">Shofu Beautifil II</span> (sử dụng hệ thống keo dán <span className=\"text-[#00ADEF] font-bold\">Shofu BeautiBond Universal</span>). Để đạt được bề mặt nhẵn mịn như men răng thật, bác sĩ đã tiến hành đánh bóng tích cực bằng hệ thống đĩa <span className=\"text-[#00ADEF] font-bold\">Shofu Super-Snap</span>, kết hợp mũi cao su <span className=\"text-[#00ADEF] font-bold\">OneGloss</span> và sáp đánh bóng <span className=\"text-[#00ADEF] font-bold\">DirectDia Paste</span>. Kết quả cho thấy các đốm màu đã được che lấp hoàn toàn, răng đạt độ bóng láng và tệp màu hoàn hảo." }
    ],
  ...
  },
  {
    ...
    images: [
      ...
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-7.2.webp", note: "<strong className=\"text-slate-900\">Phân tích quang học với nền đen:</strong> Bác sĩ sử dụng tấm nền đen (contrastor) trong miệng để chụp cận cảnh, cô lập ánh sáng chói. Bước này giúp làm nổi bật rõ rệt độ trong mờ (translucency) ở phần rìa cắn, độ dày của men răng và chi tiết các đốm trắng. Đây là thao tác bắt buộc để thiết lập \"bản đồ màu sắc\" (color mapping) chuẩn xác, chuẩn bị cho kỹ thuật sửa soạn, bôi keo dán <span className=\"text-[#00ADEF] font-bold\">Shofu BeautiBond Universal</span> và đắp lớp (layering) bằng các sắc độ ngà, men của hệ thống composite <span className=\"text-[#00ADEF] font-bold\">Shofu Beautifil II</span> ở các bước tiếp theo." }
    ],
