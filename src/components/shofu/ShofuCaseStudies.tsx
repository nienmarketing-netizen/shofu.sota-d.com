...
const caseStudies = [
  {
    ...
    images: [
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-1.1.webp", note: "<strong className=\"text-slate-900\">Tình trạng ban đầu:</strong> Khoảng thưa rõ rệt giữa hai răng 11 và 21, gây mất thẩm mỹ khi giao tiếp." },
  ...
  },
  {
    ...
    images: [
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-2.1.webp", note: "<strong className=\"text-slate-900\">Tình trạng ban đầu:</strong> Lỗ sâu loại II lớn ở răng cối nhỏ hàm dưới liên quan mặt nhai và mặt bên, gây mất mô răng đáng kể." },
      ...
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-2.3.webp", note: "<strong className=\"text-slate-900\">Sửa soạn xoang:</strong> Sửa soạn xoang hoàn tất. Mô sâu được loại bỏ hoàn toàn, tạo xoang sạch tối ưu cho phục hình." },
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-2.4.webp", note: "<strong className=\"text-slate-900\">Đặt khuôn & Chêm:</strong> Khuôn phục hồi kim loại và chêm gỗ được đặt để tái tạo hình thể mặt bên và điểm tiếp xúc tự nhiên." },
  ...
  },
  {
    ...
    images: [
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-3.1.webp", note: "<strong className=\"text-slate-900\">Tình trạng ban đầu:</strong> Răng cối nhỏ tổn thương xoang loại II lớn ở mặt nhai và kẽ mặt bên do sâu hoặc bong vật liệu phục hồi cũ." },
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-3.2.webp", note: "<strong className=\"text-slate-900\">Cách ly và sửa soạn:</strong> Răng được cách ly an toàn và khô ráo tuyệt đối bằng hệ thống <span className=\"text-[#00ADEF] font-bold\">đê cao su</span> (<span className=\"text-[#00ADEF] font-bold\">rubber dam</span>). Bác sĩ đã tiến hành làm sạch toàn bộ mô ngà nhiễm khuẩn, sửa soạn thành vách xoang gọn gàng, sẵn sàng cho quy trình dán dính." },
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-3.3.webp", note: "<strong className=\"text-slate-900\">Bôi keo dán và đặt lớp lót:</strong> Xoang phục hồi sáng bóng sau khi được xử lý bề mặt và phủ hệ thống keo dán <span className=\"text-[#00ADEF] font-bold\">Shofu BeautiBond Xtreme</span> giúp bám dính vi cơ học tối đa. Ở phần đáy xoang và mặt bên, bác sĩ lót một lớp mỏng composite <span className=\"text-[#00ADEF] font-bold\">Shofu Beautifil Flow Plus</span> để đảm bảo vật liệu len lỏi khít sát vào các góc khuất, ngăn ngừa bọt khí và vi kẽ." },
  ...
  },
  {
    ...
    images: [
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-5.1.webp", note: "<strong className=\"text-slate-900\">Tình trạng ban đầu:</strong> Các \"tam giác đen\" xuất hiện rõ rệt ở vùng kẽ răng cửa hàm dưới do tụt gai nướu, làm giảm đáng kể thẩm mỹ nụ cười." },
  ...
  },
  {
    ...
    images: [
      { url: "https://cdn.jsdelivr.net/gh/nienmarketing-netizen/shofu.sota-d.com@main/public/images/Case%20Study/case-study-7.1.webp", note: "<strong className=\"text-slate-900\">Tình trạng ban đầu:</strong> Răng 21 bị gãy vỡ mất góc gần và một phần rìa cắn. Bề mặt men răng có các gợn trắng và vệt màu tự nhiên đòi hỏi vật liệu phục hồi phải tái tạo hiệu ứng tương đồng." },
