      ...
      <section className="py-20 lg:py-28 bg-slate-100 bg-grid-pattern relative overflow-hidden border-t border-slate-200">
        <div className="w-[90%] lg:w-[80%] mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="font-body text-slate-600 max-w-3xl mx-auto leading-relaxed text-base sm:text-lg">
            ...
            <p className="font-body text-base sm:text-lg text-slate-700 font-medium max-w-3xl mx-auto leading-relaxed mt-4">
