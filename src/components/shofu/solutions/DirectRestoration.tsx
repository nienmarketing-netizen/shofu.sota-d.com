        ...
        <div className="w-[90%] lg:w-[80%] mx-auto max-w-3xl">
          ...
          <div className="flex justify-center mt-12 w-full">
            <CtaButton ctaName="GiaiDapThacMac" 
              ...
              className="group relative inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-slate-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-mono text-[10.5px] min-[375px]:text-xs sm:text-sm font-bold tracking-tight sm:tracking-wider hover:bg-slate-800 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto whitespace-nowrap flex-nowrap"
            >
