   ...
   <div className="w-[90%] lg:w-[80%] mx-auto relative z-10">
    ...
    <div className="inline-flex flex-wrap sm:flex-nowrap items-center gap-3 sm:gap-5 mb-8 sm:mb-12 bg-white p-2.5 sm:p-3 px-4 sm:px-6 rounded-full shadow-sm border border-slate-200">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <img referrerPolicy="no-referrer" src="https://cdn.jsdelivr.net/gh/nienmarketing-netizen/sota-d@03c66c4af6e28e2a69254e4d674c5a45ab53e988/Sota-D%20logo%20(1).png" alt="Sota-D Logo" className="h-5 sm:h-7 object-contain" />
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <img referrerPolicy="no-referrer" src="https://cdn.jsdelivr.net/gh/nienmarketing-netizen/sota-d@03c66c4af6e28e2a69254e4d674c5a45ab53e988/Logo_Shofu%20(1).png" alt="Shofu Logo" className="h-5 sm:h-7 object-contain" />
      </div>
    </div>
